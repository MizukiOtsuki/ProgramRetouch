				...
				<div class="card grey lighten-5">
					<div class="card-content">
						<table class="bordered">
							...
							<tbody>
						<c:forEach var="ByData" items="${buyDataList}">
								<tr>
									<td class="center"><a href="UserBuyHistoryDetail?buy_id=${ByData.id}" class="btn-floating btn waves-effect waves-light "> <i class="material-icons">details</i></a></td>
									<td class="center">${ByData.formatDate}</td>
									<td class="center">${ByData.deliveryMethodName}</td>
									<td class="center">${ByData.totalPrice}円</td>
								</tr>
								</c:forEach>
